...
export const metadata = {
  title: "CRYPTOVERSIDAD",
  description:
    "Built using MACI: Open-source Retro Public Goods Funding platform with MACI for private on chain voting/",
...
export const impactCategories = {
  // Category: Developers, Governance, Events, Education/Onboarding, Other.
  DEVELOPERS: { label: "Developers" },
  GOVERNANCE: { label: "Governance" },
  EVENTS: { label: "Events" },
  EDUCATION_ONBOARDING: { label: "Education/Onboarding" },
  OTHER: { label: "Other" },
} as const;
